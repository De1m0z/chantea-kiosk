    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#FFFCF5] via-[#FDFBF7] to-[#F1F8E6] flex flex-col items-center justify-center p-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(#5D4037 1px, transparent 1px)', backgroundSize: '24px 24px' }}></div>
            </div>
                            ...
                            >
                                ...
                                <div className="relative h-full flex flex-row items-center justify-between p-8 text-white">
                                    <div className="flex flex-col items-start justify-center flex-1">
                                        <h2 className="text-4xl font-black mb-1 text-white tracking-wide">Order Now</h2>
                                        <p className="text-white/90 text-sm font-bold tracking-wider opacity-90 uppercase">Click to Start</p>
                                    </div>
                            ...
                            <div className="relative w-full max-w-xl bg-white rounded-[3rem] shadow-2xl shadow-gray-200 border-4 border-white p-10 md:p-14 flex flex-col items-center text-center transition-all duration-300 hover:shadow-3xl hover:-translate-y-2 hover:border-matcha/20 cursor-pointer">
                                ...
                                <div className="w-full mb-6">
                                    <div className="flex items-center justify-center gap-2 mb-4">
                                        ...
                                        <h4 className="text-2xl font-serif font-bold text-matcha">Buy 10, Get 1 FREE!</h4>
                                    </div>
                                    ...
                                    <p className="text-xs text-espresso-light">Collect stamps with every drink purchase!</p>
                                </div>
                                ...
                                <p className="text-espresso-light mb-6 text-lg font-medium leading-relaxed max-w-sm">
                                    Scan to start collecting stamps and earn <span className="font-bold text-matcha">FREE drinks</span>!
                                </p>
                ...
                {view === "ORDER_TYPE" && (
                    <div className="w-full max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 animate-in slide-in-from-right-8 fade-in duration-500">
                            ...
                            >
                                ...
                                <div className="relative h-full flex flex-col items-center justify-center p-8 text-white">
                                    ...
                                    <h2 className="text-5xl md:text-6xl font-serif font-black mb-2 md:mb-3 tracking-wide drop-shadow-sm text-white">Dine In</h2>
                                    <p className="text-white/90 text-xl font-bold tracking-wider opacity-90">Enjoy here</p>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div className="relative h-full flex flex-col items-center justify-center p-8 text-white">
                                    ...
                                    <h2 className="text-5xl md:text-6xl font-serif font-black mb-2 md:mb-3 tracking-wide drop-shadow-sm text-white">Take Out</h2>
                                    <p className="text-white/90 text-xl font-bold tracking-wider opacity-90">To go</p>
                                </div>
                            </button>
                        </div>
                        ...
                        <div className="mt-16 text-center animate-in fade-in duration-700">
                            ...
                            >
                                <span className="group-hover:-translate-x-1 inline-block transition-transform duration-300">←</span> Back
                            </button>
                        </div>
                    </div>
                )}
